...
//! Project version number for Moment.
FOUNDATION_EXPORT double MomentVersionNumber;

//! Project version string for Moment.
FOUNDATION_EXPORT const unsigned char MomentVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <Moment/PublicHeader.h>
